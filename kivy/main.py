...
class CDataApp(App):
    ...
    def botao_meses(self):
        ...
        if tmp == 'ERRO':
            ...
            result = self.calcula(tmp[0], tmp[1], tmp[2], 'M')
            self.root.ids.ti_resultado.text = result
    ...
    def botao_anos(self):
        ...
        if tmp == 'ERRO':
            ...
            result = self.calcula(tmp[0], tmp[1], tmp[2], 'A')
            self.root.ids.ti_resultado.text = result
        # tmp = self.ler_operacao()
        # data_final = None
        # print('tmp: ', tmp)
        ...
        # try:
        #     if tmp[2] == '+':
        #         datatmp = datetime.strptime(tmp[0], '%d/%m/%Y')
        #         data_final = datatmp + relativedelta(days=int(tmp[1]))
        #         print('positivo')
        #         self.root.ids.ti_resultado.text = datetime.strftime(data_final, '%d/%m/%Y')
        #     if tmp[2] == '-':
        #         datatmp = datetime.strptime(tmp[0], '%d/%m/%Y')
        #         data_final = datatmp - relativedelta(days=int(tmp[1]))
        #         print('negativo')
        ...
        #     print('Operação inválida: ', err)
        #     self.root.ids.ti_resultado.text = 'ERRO'
        #     pass
